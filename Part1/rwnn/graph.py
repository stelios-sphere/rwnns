...
def build_random_dag(
    ...
    # Topological levels (inputs + biases at 0; compute nodes by max-parent + 1).
    ...
    # Sort nodes by (level, node_id) for stable, contiguous levels.
    ...
    # Fill any empty trailing entries.
